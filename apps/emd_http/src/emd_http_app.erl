...
start(_StartType, _StartArgs) ->
    {ok, Port} = application:get_env(emd_http, http_port),
    {ok, Ssl} = application:get_env(emd_http, ssl),
    Routes = get_routes(),
...
%% @doc Define the Client-Server API routes.
get_routes() ->
    [
     {'_', [
            ...
            {"/_matrix/client/r0/register",                                        emd_http_auth_register, []},
            {"/_matrix/client/r0/register/email/requestToken",                     emd_http_auth_register_email_reqtoken, []},
            {"/_matrix/client/r0/register/msisdn/requestToken",                    emd_http_auth_register_msisdn_reqtoken, []},
            {"/_matrix/client/r0/account/password",                                emd_http_auth_password, []},
            {"/_matrix/client/r0/account/password/email/requestToken",             emd_http_auth_password_email_reqtoken, []},
            {"/_matrix/client/r0/account/password/msisdn/requestToken",            emd_http_auth_password_msisdn_reqtoken, []},
            {"/_matrix/client/r0/account/deactivate",                              emd_http_auth_deactivate, []},
            {"/_matrix/client/r0/register/available",                              emd_http_auth_available, []},
            {"/_matrix/client/r0/account/whoami",                                  emd_http_auth_whoami, []},
